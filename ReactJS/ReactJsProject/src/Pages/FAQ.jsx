...
import FAQaccordian from '../PageHelpers/FAQaccordian';
...
const FAQ = () => {
  return (
    <div>
      <div>
        <Allinnerbanner title='FAQ' Breadcrumbs='FAQ' />
      </div>
      <div className='container-section block lg:flex gap-5 py-10'>
        {/* Accordian */}
        ...
        <div className='bg-[#f2f2f2] lg:w-[40%] xl:w-[35%] h-fit p-6 md:p-14 lg:p-8 xl:p-12 rounded-lg mt-8'>
          ...
          <div className='flex items-center gap-5'>
            <NavLink to="/contact" className='bg-black text-white rounded-sm       px-3 py-2'>Contact Us</NavLink>
