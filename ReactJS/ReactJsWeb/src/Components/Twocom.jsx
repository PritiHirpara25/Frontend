  ...
  return (
    <div className='container-section'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-8'>
        <div className='relative overflow-hidden hoverscreen'>
          <img src={smartassistant} className=" rounded-2xl object-cover h-full w-full" alt="" />
        ...
        <div className='relative overflow-hidden hoverscreen'>
          <img src={trueearbuds} className="rounded-2xl h-full w-full object-cover" alt="" />
          <div className='absolute bottom-3 left-1/4 right-1/4 text-center'>
